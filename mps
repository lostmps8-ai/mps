...
local Window = Library:CreateWindow({
	Title = "EPSTEIN HUB",
	Footer = "ALL RIGHTS RESERVED TO EPSTEIN FAMILY",
	Icon = false,
	NotifySide = "Right",
...
if workspace:FindFirstChild("Balls", true) then
	...
	for ID, Ball in pairs(workspace:GetChildren()) do
		if Ball.Name == "fakeBaIlExpIoiter" or Ball.Name == "ROFI" or Ball.Name == "fakeBall" or Ball.Name == "MPS" or Ball.Name == "TPS" or Ball.Name == "CSF" or Ball.Name == "l̸̼̔il̷͎̅ḭ̴͘iḮ̷̙il̶̼̈́il̴̘̕Ĩ̵̹į̴̌" or Ball.Name == "SAML" or Ball.Name == "VEF" or Ball.Name == "VFA" or Ball.Name == "VRF" then
